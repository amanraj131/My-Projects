...
<html>
  ...
  <body ng-app="myApp" class="ng-cloak">
      <div class="ng-cloak generic-container" ng-controller="UserController as ctrl" >
      ...
      <script src="<c:url value='/static/service/user_service.js' />"></script>
      <script src="<c:url value='/static/controller/user_controller.js' />"></script>
  </body>
</html>